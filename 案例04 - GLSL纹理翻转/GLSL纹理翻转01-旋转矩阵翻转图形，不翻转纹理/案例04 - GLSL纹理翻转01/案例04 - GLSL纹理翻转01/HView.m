...
-(void)renderLayer{
    ...
    glVertexAttribPointer(textCoor, 2, GL_FLOAT, GL_FALSE, 5*sizeof(GLfloat), (GLfloat*)NULL+3);
...
- (void)rotateTextureImage{
    ...
    //该矩阵主要是用来将图片翻转，在OpenGL中，矩阵都是列向量，因此，Y轴翻转只需要将对应的轴上的数据*-1。
    //如果需要在该方向进行缩放，也可以将1/-1，改成缩放因子。
    //总结，符号：正-方向不变；负-翻转
    //数字：缩放因子
